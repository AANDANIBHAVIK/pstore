...
import 'package:pstore/screenmodel.dart';
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Image.asset(Provider.of<screenoeprovider>(context).datatwo[index].photo as String),
                      ),
                    ),
                    //SizedBox(height: 5,),
                    Padding(
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: ClipRRect(
                            ...
                            child: Image.asset(Provider.of<screenoeprovider>(context).datathree[index].photo as String,)),
                      ),
                    ),
                    //SizedBox(height: 5,),
                    Padding(
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Image.asset(Provider.of<screenoeprovider>(context).datafour[index].photo as String),
                      ),
                    ),
                    //SizedBox(height: 5,),
                    Padding(
